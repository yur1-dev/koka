// prisma/seed.ts (FULLY FIXED: No attributes (add after schema push); Use create with logging; Balanced 100 items; Safe clear/re-run)
...
async function main() {
  ...
  console.log(`✅ Created ${created} collectibles\n`);
